...
import Cma from "@/app/assets/cma.jpg";
const Footer = () => {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-neutral-800 mb-4">
              A professional martial arts institute offering training in
              multiple disciplines with global standards. Proud partner of
              Fightclub India.
            </p>
            <a
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-neutral-800 mb-4">
              Master the ancient arts with authentic training programs, premium
              equipment, and professional workshops.
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-zinc-400/50 mt-8 pt-8 text-center">
          <p className="text-neutral-800">
            © 2024 Fightclub India. All rights reserved. An Extension of Chennai
            Martial Arts.
          </p>
        </div>
      </div>
